...
export function BabyNamesView() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="p-4 sm:p-5 rounded-3xl bg-white dark:bg-charcoal-900 border border-rose-100 dark:border-charcoal-800 shadow-soft space-y-3">
        ...
        <div className="flex flex-wrap items-center justify-between gap-2 pt-1">
              ...
              <button
                ...
                className={`px-3 py-1.5 rounded-xl border transition ${
                  genderFilter === g
                    ...
                    : 'bg-white dark:bg-charcoal-800 border-rose-100 dark:border-charcoal-700 text-charcoal-600 dark:text-charcoal-300 hover:bg-rose-50'
                }`}
              >
                {g === 'all'
                  ? t.names.categoryAll
          ...
          <button
            ...
            className={`px-3 py-1.5 rounded-xl border text-xs font-semibold flex items-center space-x-1.5 transition ${
              favoritesOnly
                ? 'bg-rose-50 border-rose-300 text-rose-600 dark:bg-rose-950/40 dark:border-rose-800 dark:text-rose-300'
                : 'bg-white dark:bg-charcoal-800 border-rose-100 dark:border-charcoal-700 text-charcoal-600 dark:text-charcoal-400 hover:bg-rose-50'
            }`}
          >
      ...
      {filteredNames.length > 0 ? (
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
          {filteredNames.map((item) => {
            ...
            return (
              <div
                key={item.id}
                className="p-5 rounded-3xl bg-white dark:bg-charcoal-900 border border-rose-100 dark:border-charcoal-800 shadow-soft flex flex-col justify-between space-y-3 group hover:border-rose-200 transition"
              >
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <p className="text-sm font-bangla text-rose-600 dark:text-rose-400 font-semibold">
                      {item.banglaName}
                    </p>
                  </div>
                  ...
                  <button
                    ...
                    className="p-2 rounded-xl text-charcoal-300 hover:text-rose-500 transition"
                ...
                <div className="pt-2 border-t border-rose-50 dark:border-charcoal-800 flex items-center justify-between text-[11px] text-charcoal-400">
        ...
        <div className="text-center py-12 bg-white dark:bg-charcoal-900 rounded-3xl border border-rose-100 dark:border-charcoal-800 shadow-soft">
